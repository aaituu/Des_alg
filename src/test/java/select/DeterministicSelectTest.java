...
@Test
public void testSelectVsArraysSort100Trials() {
    ...
    for (int trial = 0; trial < 100; trial++) {
        ...
        int actual = DeterministicSelect.select(Arrays.copyOf(arr, arr.length), k);
        assertEquals(expected, actual, "Trial " + trial + " failed");
    }
}
}
